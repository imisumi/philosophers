...
/*   Updated: 2023/11/10 17:36:09 by imisumi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	*routine(void *arg)
{
	...
	// if (seat->philo.id % 2 == 1)
	// 	ft_usleep(seat, 1);
		// ft_usleep(seat, seat->data->time_to_eat / 2);

	if (seat->philo.id % 3 == 2)
		ft_usleep(seat, seat->data->time_to_eat / 2);
	if (seat->philo.id % 3 == 0)
		ft_usleep(seat, seat->data->time_to_eat);
	...
	while (philo_can_continue(seat) == true)
	{
		...
		print_state(seat, THINKING);
		// ft_usleep(seat, (seat->data->time_to_eat / 2));
		ft_usleep(seat, seat->data->time_to_eat + (seat->data->time_to_eat / 2));
	}
	return (NULL);
}
